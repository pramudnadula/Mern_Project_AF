...
function Layout1(props) {
    ...
    >
      ...
      >
        ...
        {bool ? (
          <>
            <Menu.Item key="2" icon={<DesktopOutlined />}>
              <Link to={`/evaluate/view/group/${gid}`}>Results</Link>
            </Menu.Item>
          </>
        ) : (
          <></>
        ...
        <SubMenu key="sub2" icon={<UserOutlined />} title="Supervisors">
          <Menu.Item key="6">
            <Link to="/req" className="links">
              Supervisor
            </Link>
          </Menu.Item>
          <Menu.Item key="7">
            <Link to="/creq" className="links">
              Co-supervisor
            </Link>
          </Menu.Item>
        </SubMenu>
        <SubMenu key="sub3" icon={<FilePdfOutlined />} title="Documentation">
          <Menu.Item key="8">
            <Link to="/AllSubmission" className="links">
              Submissions
            </Link>
          </Menu.Item>
          <Menu.Item key="9">
            <Link to="/UploadDocument" className="links">
              Document
            </Link>
          </Menu.Item>
        </SubMenu>
  ...
  const slider2 = () => (
    <Sider
      ...
      collapsed={collapsed}
      onCollapse={onCollapse}
      style={{ backgroundColor: "rgb(231, 55, 55)" }}
    >
      <div className="logo" />
      <Menu
        theme="light"
      ...
      >
        ...
        <SubMenu key="sub3" icon={<FilePdfOutlined />} title="Documentation">
          <Menu.Item key="8">
            <Link to="/CreateSubmission" className="links">
              Create Submission
            </Link>
          </Menu.Item>
          <Menu.Item key="9">
        ...
        <Menu.Item key="10" icon={<TeamOutlined />}>
          <Link to="/allocatedgroups" className="links">
            {" "}
            Group
          </Link>
        </Menu.Item>
    ...
    <>
        ...
        <>
          ...
          <Layout
            ...
            className={
              ...
              location.pathname === "/staffregister"
                ? "block"
                : ""
            }
          >
      ...
      {localStorage.getItem("staff") ? (
        <>
          <Navbar_staff />
          <Layout
            style={{ minHeight: "calc(100vh - 3.37rem) " }}
            className={
              location.pathname === "/" ||
