...
const fs = require('fs');
// const perf = require('./mail-message.html');
...
const sendMail = function (email, token) {
  ...
  let transporter = nodemailer.createTransport({
    ...
    auth: {
      user: 'rmsliit12@outlook.com', // generated ethereal user
  ...
  let info = transporter.sendMail({
    from: 'rmsliit12@outlook.com', // sender address
                    ...
                    <tr>
                      <td>
                        ...
                        <p style="text-align: center;">
                          <b
                            >Please click on the following button to reset your
                            Password</b
                          >
                        </p>
                        <table
